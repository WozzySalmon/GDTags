...
func _load_native_extension() -> bool:
	if ClassDB.class_exists("NativeGameplayTagRegistry") and ClassDB.class_exists("NativeGameplayTagDatabase"):
	...
	return _native_load_error == OK and ClassDB.class_exists("NativeGameplayTagRegistry") and ClassDB.class_exists("NativeGameplayTagDatabase")
